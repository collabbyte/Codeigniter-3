...
<head>  
  ...
  <!-- Example Add Plugins
  <link rel="stylesheet" type="text/css" href="<?php echo AssetsURL() ?>plugins/OwlCarousel/assets/owl.carousel.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo AssetsURL() ?>plugins/OwlCarousel/assets/owl.theme.default.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo AssetsURL() ?>plugins/summernote/summernote.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo AssetsURL() ?>plugins/DataTables/datatables.min.css"/>
  -->
